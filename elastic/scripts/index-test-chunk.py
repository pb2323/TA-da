...
# Load .env.local from repo root if python-dotenv is available
try:
...
_default_es_url = "https://my-elasticsearch-project-f5fc5f.es.us-west1.gcp.elastic.cloud:443"
ES_URL = (os.environ.get("ELASTICSEARCH_URL") or "").strip() or _default_es_url
